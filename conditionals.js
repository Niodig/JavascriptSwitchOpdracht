...
const anwser = 10 > 20;
console.log('Is 10 groter dan 20?', anwser);
...
const anwser1 = 10 != 11;
console.log('Is 10 ongelijk aan 11', anwser1);

// ==========================================
// 3. Declareer een variabele en sla daar in op of de woorden 'zoet' en 'sappig' hetzelfde zijn                // geeft false wanneer gelogd
// ==========================================

const anwser2 = 'zoet' == 'sappig';
console.log('Is zoet het zelfde als sappig?', anwser2);
...
if (isRaining || temperature  < 12) {
    console.log('Doe maar een jas aan!');
}